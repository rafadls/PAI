...
echo_and_run cd "/home/rafael/PAI/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rafael/PAI/src/kobuki/kobuki_testsuite/setup.py" \
     \
    build --build-base "/home/rafael/PAI/build/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
