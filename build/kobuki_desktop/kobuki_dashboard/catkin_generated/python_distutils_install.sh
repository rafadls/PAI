...
echo_and_run cd "/home/rafael/PAI/src/kobuki_desktop/kobuki_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rafael/PAI/src/kobuki_desktop/kobuki_dashboard/setup.py" \
     \
    build --build-base "/home/rafael/PAI/build/kobuki_desktop/kobuki_dashboard" \
    install \
    --root="${DESTDIR-/}" \
